  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="group relative">
      ...
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute left-1/2 top-[calc(100%_+_1.2rem)] -translate-x-1/2 transform">
              <motion.div
                transition={transition}
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="shadow-input relative flex items-center justify-between space-x-4 border border-transparent bg-white/30 px-3 py-4 dark:border-white/[0.2] dark:bg-black/60"
    >
      {children}
    </nav>
  );
